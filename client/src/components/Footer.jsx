    ...
    return (
        <Container>
            <Left>
                <Logo>HYHO</Logo>
                <Desc>
                    Nuevamente agradecemos su tiempo invertido al visitar nuestra app-web y su ganas de ayudar a construir juntos una sociedad mejor.
                </Desc>
                <SocialContainer>
            ...
            <Right>
                ...
                <ContactItem>
                    <Room style={{ marginRight: "10px" }} /> 101 margarita, CABA, Buenos Aires
                </ContactItem>
                <ContactItem>
